...
Return one structured action at a time.
Request built-in tools explicitly, inspect tool results carefully, and stop only when the task is complete or blocked under the harness stop conditions.
